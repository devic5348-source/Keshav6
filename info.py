...
PICS = (environ.get('PICS', 'https://envs.sh/uM5.jpgp')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8211449985').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002742983860').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002839820255') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002947570478')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://golumandal369:rItvgZ1JeeOdn2to@cluster0.ecbu48o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'publicfilechannel1') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_request_groups_9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/nexuskingdom6')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'NexusSupportGroup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/KeshavTheOwner')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'f64c396e2eecef292e59c04bf38fbf20037605a9')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Themoviesnexustutorial/11')
